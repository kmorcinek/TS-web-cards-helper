...
var countries = [
    ...
    new Country(31, "Afganistan", , ),
    new Country(32, "Pakistan", , ),
    new Country(33, "India", , ),
    new Country(34, "Burma", , ),
    new Country(35, "Laos/Cambodia", , ),
    new Country(36, "Thailand", , ),
    new Country(37, "Vietnam", , ),
    new Country(38, "Malaysia", , ),
    new Country(39, "Indonesia", , ),
    new Country(40, "Philippines", , ),
    new Country(41, "Australia", , ),
    new Country(42, "Japan", , ),
    new Country(43, "Taiwan", , ),
    new Country(44, "S. Korea", , ),
    new Country(45, "N. Korea", , ),
    new Country(46, "Tunisia", , ),
    new Country(47, "Algeria", , ),
    new Country(48, "Morocco", , ),
    new Country(49, "West African States", , ),
    new Country(50, "Ivory Coast", , ),
    new Country(51, "Saharan States", , ),
    new Country(52, "Nigeria", , ),
    new Country(53, "Cameroon", , ),
    new Country(54, "Zaire", , ),
    new Country(55, "Angela", , ),
    new Country(56, "South Africa", , ),
    new Country(57, "Botswana", , ),
    new Country(58, "Zimbabwe", , ),
    new Country(59, "SE African States", , ),
    new Country(60, "Kenya", , ),
    new Country(61, "Somalia", , ),
    new Country(62, "Ethiogia", , ),
    new Country(63, "Sudan", , ),
    new Country(64, "Mexico", , ),
    new Country(65, "Guatemala", , ),
    new Country(66, "El Salvador", , ),
    new Country(67, "Honduras", , ),
    new Country(68, "Costa Rica", , ),
    new Country(69, "Panama", , ),
    new Country(70, "Nicaragua", , ),
    new Country(71, "Cuba", , ),
    new Country(72, "Haiti", , ),
    new Country(73, "Dominican Rep", , ),
    new Country(74, "Colombia", , ),
    new Country(75, "Venezuela", , ),
    new Country(76, "Brazil", , ),
    new Country(77, "Uruguay", , ),
    new Country(78, "Paraquay", , ),
    new Country(79, "Argentina", , ),
    new Country(80, "Chila", , ),
    new Country(81, "Peru", , ),
